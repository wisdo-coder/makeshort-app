...
// Change the check to be more forgiving
  if (!clip) return null;

  // If segments haven't loaded yet, show a small loading message instead of nothing
  if (!editedSegments || editedSegments.length === 0) {
    return (
      <div className="text-center p-10 bg-gray-900 rounded-2xl border border-dashed border-gray-700">
        <p className="text-gray-400">Loading subtitle segments...</p>
      </div>
    );
  }
